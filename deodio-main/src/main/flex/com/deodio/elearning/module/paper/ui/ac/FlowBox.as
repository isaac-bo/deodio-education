...
package com.deodio.elearning.module.paper.ui.ac {
	...
	public class FlowBox extends Box {
		...
		override public function setStyle(styleProp:String, newValue:*):void {
			...
			if (this.initialized && (styleProp == "horizontalAlign" || styleProp == "verticalAlign" || styleProp == "horizontalGap" || styleProp == "verticalGap" || styleProp == "paddingLeft" || styleProp == "paddingTop" || styleProp == "paddingRight" || styleProp == "paddingBottom"))
				relayoutChildren();
		}

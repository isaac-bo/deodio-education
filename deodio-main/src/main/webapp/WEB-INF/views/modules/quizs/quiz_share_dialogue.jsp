...
<div class="modal fade" id="quizShareModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
	<div class="modal-dialog" role="document" style="width: 800px;">
		<div class="modal-content" id="quizShareModalContent">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
				<h4 class="modal-title">分享综合试卷</h4>
			</div>
			<div class="modal-body hdn" style="height: 400px;">
				<div id="right_content_quiz_share">
					...
					<table cellpadding="0" cellspacing="0"
						...
						<tbody id="table_content_quiz_share">
						</tbody>
					</table>
					<!-- 分页 -->
					<div class="mt20 text-center" id="course_setting_quiz_share_panel">
					</div>
				</div>
			</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn_green btn_160_36"
					onclick="shareQuizToUser();" btn-type='true' data-dismiss="modal">提交</button>
...
<script id="right_content_quiz_share_template" type="text/x-dot-template">
{{~it.data:v:index}}
...
<script type="text/javascript">
	require([ 'modules/quizs/quiz_share_dialogue' ], function() {
	});
</script>

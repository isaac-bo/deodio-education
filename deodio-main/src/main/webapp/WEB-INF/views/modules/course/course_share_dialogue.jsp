...
<div class="modal fade" id="courseShareModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
			...
			<div class="modal-body hdn" style="height: 400px;">
				<div id="right_content_course_share">
					...
					<table cellpadding="0" cellspacing="0" class="table table-striped table-hover td_h60 mt20">
						...
						<tbody id="table_content_course_share">
						</tbody>
					</table>
					<!-- 分页 -->
					<div class="mt20 text-center" id="course_setting_course_share_panel"></div>
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn_green btn_160_36"
					onclick="shareCourse();" btn-type='true' data-dismiss="modal">提交</button>
				<button type="button" class="btn btn_gray btn_160_36" data-dismiss="modal">关闭</button>
			</div>
		</div>
	</div>
</div>
<script id="right_content_course_share_template" type="text/x-dot-template">
{{~it.data:v:index}}
...
<script type="text/javascript">
	require([ 'modules/course/course_share_dialogue' ], function() {
	});
</script>

	   ...
	   <div class="modal-content" id="courseCopyModalContent">
		   <div class="modal-header">
			...
			<div class="modal-footer">
				<!-- <button type="button" class="btn btn_green btn_160_36" onclick="submitNewCourse();" btn-type='true' data-dismiss="modal">提交</button> -->
				<button type="button" class="btn btn_green btn_160_36" onclick="submitNewCourse();">提交</button>
...
<script type="text/javascript">
	require(['modules/course/course_copy_dialogue'],function(){	
	});
</script>

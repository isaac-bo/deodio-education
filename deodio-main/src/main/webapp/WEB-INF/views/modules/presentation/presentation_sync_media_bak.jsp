...
<!--                     	<button class="edit_btn" type="button"><span class="icon-pencil"></span></button> -->
    ...
    <div id="time_all" style="width: 100%;position: relative;">       
            <div class="time_scale" id="time_scale_up" style="overflow: hidden;padding-left: 0;float: right;width: 1350px;">
                <div class='ruler' style="width: 12000px;">
						<div class='cm' style='left: 0px;'>
							<span>00:00:00</span>
							<div class='mm'></div>
							<div class='mm'></div>
							<div class='mm'></div>
						...
						<div class='cm' style='left: 1120px;'>
							<span>00:00:00</span>
							<div class='mm'></div>
							<div class='mm'></div>
							<div class='mm'></div>
						...
						<div class='cm' style='left: 1280px;'>
							<span>00:00:00</span>
							<div class='mm'></div>
							<div class='mm'></div>
							<div class='mm'></div>
						...
						<div class='cm' style='left: 1440px;'>
							<span>00:00:00</span>
							<div class='mm'></div>
							<div class='mm'></div>
							<div class='mm'></div>
            ...
            <div class="height_auto" style="height:333px;overflow-y:scroll;"><!--高度根据窗口尺寸计算-->
                ...
                <div id="time_line_down" class="right_con_height" style="width:756px;overflow-x:auto;float:left;">
                    <ul class="bottom_list" style="width:100%;"><!--宽度根据里面内容多少来算-->
                        <li class="mediaLine">
                            <%-- <div class="material_pic">
                                <img src="${ctx}/resources/img/editor/m_pic.png" alt="" class="pic_size">
                                <span class="btm"><button type="button"><img src="${ctx}/resources/img/editor/del_icon.png" alt=""></button></span>
                            </div> --%>
                        </li>
 ...
 <div id="time_pointer" class="pointer" style="left:170px;"></div> <!-- 每移动一个图片距离是多加160像素         -->   
  </div>           
            <!-- end -->

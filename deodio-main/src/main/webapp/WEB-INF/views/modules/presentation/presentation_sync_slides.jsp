...
<body class="video_bg">
	...
	<input type="hidden" id="syncType" value="slides"/>
    ...
    <c:if test="${type==null}">
        ...
        <div class="video_box">
            ...
            <div class="video_con" style="width:100%;">
                <div class="top_title"  style="width:100%;">
                    <h3>SLIDES</h3>
                 
                </div>
                <div class="video_box2">
                    <div class="left_video" style="width:100%;">
                    	<div class="left_video_content" style="text-align:center;vertical-align:middle;position: absolute; width: 640px; height: 100%;left: 50%;margin-left: -320px;"></div>
<!--                     	<button class="edit_btn" type="button"><span class="icon-edit"></span></button> -->
                    ...
                    <button class="paly_btn" onclick="playSlides(this);" type="button"><img src="${ctx}/resources/img/editor/play_icon.png" alt=""></button>
                    <button id="pause_btn" style="position: absolute;left: 0px;bottom: 0px;background: none;display: none;" onclick="pauseSlides(this);" type="button"><img src="${ctx}/resources/img/editor/pause.png" alt=""></button>
                </div>
           ...
           <input type="hidden" id="currentTime" value="0"/>    
            ...
            <div id="time_pointer" class="pointer" style="left:330px;top:43px;position: absolute"></div>
                ...
                <div class="height_auto" style="height:300px;overflow-y:scroll;position:relative;"><!--高度根据窗口尺寸计算-->
                    ...
                    <div id="time_line_down" class="right_con_height" style="width:899px;overflow-x:auto;float:left;"> <!-- 计算宽度 -->
                        <ul class="bottom_list" style="width:${slideLength}px;"><!--宽度根据里面内容多少来算-->
...
<script type="text/javascript">
	require(['modules/presentation/presentation','modules/editor/editor','modules/editor/sync.comment','modules/presentation/presentation_sync_slides' ], function(obj) {

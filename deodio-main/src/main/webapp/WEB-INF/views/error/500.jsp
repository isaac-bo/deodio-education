...
<body>
	...
	<div class="con">
		<img src="${ctx}/resources/img/error/500.png" alt="">
		<p>Server error, please contact with administrator</p>
		<button class="btn btn_red  btn_160_36 mt20" type="button" onclick="javascript:history.go(-1)">Go back</button>

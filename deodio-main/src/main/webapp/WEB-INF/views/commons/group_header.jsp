...
<header>
  ...
  <nav class="nav header-nav">
    ...
    <input type="hidden" id="hidden_header_cookieLogo" value="<%=URLDecoder.decode((String)CookieUtils.getCookie(request, "CLI"),"UTF-8")%>">
...
<%--         <a href="${headerLinkUrl}" target="_blank" <c:if test="${isHomepage == true}"> style="background-image: url('${ctx}/resources/img/account/logo-1.png'); margin-top: 0px;" </c:if> <c:if test="${isHomepage != true}">style="background-image: url('${headerUrl}'); margin-top: 10px;" </c:if> ></a>--%>
      ...
      <ul class="_head_menu">
	        <li id="_head_menu_2" isChild='1' style="display:none;"><a  class="" href="javascript:go2Page('/group/list.html');">我的小组 </a></li>
	        <li id="_head_menu_3" isChild='0' style="display:none;"><a  class="" href="">课程管理<span class="icons-9-5 down-1 up-1"></span></a></li>
	        <li id="_head_menu_5" isChild='1' style="display:none;"><a  class="" href="javascript:void(0);">我的报表 </a>
	        <li id="_head_menu_group" isChild='1' style="display:none;"><a  class="" href="javascript:go2Page('/group/list.html');">我的小组 <span class="icons-9-5 down-1 up-1"></span></a></li>
	        <li id="_head_menu_course" isChild='1' style="display:none;"><a  class="" href="javascript:go2Page('/course/course_viewer/list.html');">我的学习</a>
 </ul>
      <div class="personal-item">
       <div class="personal-item-layer">
          <div style="width:115px;;heigth:55px;" class="pull-left"><h1 id="header_nickName">
...
<%--         <img src="${userHeader}" width="36">--%>  
		<input type="hidden" id="hiddenheader_group_header" value="<%=URLDecoder.decode((String)CookieUtils.getCookie(request, "CUHP"),"UTF-8")%>">      
 		<%if(StringUtils.isBlank(URLDecoder.decode((String)CookieUtils.getCookie(request, "CUHP"),"UTF-8"))){ %>
          		    <img src="${ctx}/resources/img/account/homepaage_movie_travel.jpg" id="userIconPicGroupHead" width="36" style="height:34px">
        <% }else{%>
              <img src="${imgStatic}<%=URLDecoder.decode((String)CookieUtils.getCookie(request, "CUHP"),"UTF-8")%>" id="userIconPicGroupHead" width="36" style="height:34px"> 
        <%} %>

...
!function ($) {
	...
	Datetimepicker.prototype = {
		...
		//add by xuxiangdong 20170320  start
		getStartDate: function (format) {
			return DPGlobal.parseDate(this.startDate, this.format, this.language, this.formatType);
		},
		getFormattedStartDate: function (format) {
			if (format == undefined) format = this.format;
//			debugger;
			return DPGlobal.formatDate(this.startDate, this.format, this.language, this.formatType);
		},
		//add by xuxiangdong 20170320  end

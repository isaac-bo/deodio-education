...
public class DateTimeUtils extends Utils {
    ...
    public static final int DAY_OF_SECOND = 60*1000;
    public static final String FORMAT_YYYYMMDD = "yyyy-MM-dd";
    public static final String FORMAT_YYYYMMDD_HHMM = "yyyy-MM-dd HH:mm";//add by xu.xiangdong(datetimepicker)
    ...
    public static final String[] PATTERNS = new String[] {
            ...
            "yyyy-MM-dd HH:mm:ss.SSS", "yyyy-MM-dd@@HH:mm:ssZ", "yyyy.MM.dd ","yyyyMMddHHmmss"
    };
    ...
    public static String dateFormatCharacter(Date date) {  
